...
**Intent.** Even an unfrozen foreign-owned asset (FreezeDelegate{frozen:false}) is rejected on ownership.

**Outcome.** The transaction failed: `Invalid account owner`.

**Source.** [`tests/account_ownership.rs::transfer_rejects_fake_unfrozen_asset_owned_by_different_program`](../tests/account_ownership.rs#L433)
