...
**Intent.** A foreign-owned asset embeds FreezeDelegate{frozen:true}; transfer rejects it on ownership before the freeze state matters.

**Outcome.** The transaction failed: `Invalid account owner`.

**Source.** [`tests/account_ownership.rs::transfer_rejects_fake_frozen_asset_owned_by_different_program`](../tests/account_ownership.rs#L405)
