...
**Intent.** Conflicting favorable plugins (frozen + permanent transfer) on a foreign-owned account; ownership rejection wins.

**Outcome.** The transaction failed: `Invalid account owner`.

**Source.** [`tests/account_ownership.rs::transfer_rejects_fake_asset_frozen_but_with_permanent_transfer`](../tests/account_ownership.rs#L567)
